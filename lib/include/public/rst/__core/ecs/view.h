...
namespace rst::ecs
{
    namespace internal
    {
         ...
         */
        template <typename TView, meta::non_ref... TComponents> requires ( sizeof...( TComponents ) > 0U )
     ...
     */
    template <meta::non_ref... TComponents> requires ( sizeof...( TComponents ) > 0U )
    class view final
    {
        using component_tuple_type = std::tuple<internal::component_pool_type<TComponents>&...>;
    ...
    public:
         ...
         * @complexity O(1)
         */
        explicit view( internal::component_pool_type<TComponents>&... pools ) noexcept
            : pools_{ pools... }
    ...
    private:
        component_tuple_type const pools_;
