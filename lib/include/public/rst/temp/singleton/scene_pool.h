...
//         ~scene_pool( ) noexcept;
//
//         scene_pool( scene_pool const& )                        = delete;
//         scene_pool( scene_pool&& ) noexcept                    = delete;
//         auto operator=( scene_pool const& ) -> scene_pool&     = delete;
//         auto operator=( scene_pool&& ) noexcept -> scene_pool& = delete;
//
